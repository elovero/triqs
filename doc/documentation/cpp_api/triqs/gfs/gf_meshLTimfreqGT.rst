...
Pictorial representation of ``gf_mesh<imfreq>({beta, Fermion/Boson, 3, all_frequencies/positive_frequencies_only})``.
.. See :ref:`constructor <gf_mesh<imfreq>_constructor>` for more details.
